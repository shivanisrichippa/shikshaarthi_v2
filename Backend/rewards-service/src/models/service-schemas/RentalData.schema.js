...
//   // =============================================================
//   // THE FIX: Uncomment the location field and make it optional
//   // =============================================================
//   location: {
//     type: {
//         type: String,
//         enum: ['Point'],
//         // No 'required' or 'default' here, so it's optional
//     },
//     coordinates: {
...
// // =================================================================
// // THE FIX: Add the crucial 2dsphere index for geospatial queries
// // 'sparse: true' means the index will only be created for documents
// // that actually have the 'location' field.
// // =================================================================
...
// =====================================================================
// THE FIX: Added the crucial 2dsphere index for geospatial queries.
// 'sparse: true' ensures it only indexes documents that have this field.
// =====================================================================
rentalDataSchema.index({ location: '2dsphere' }, { sparse: true });
