// Backend/laundry-service/src/config/index.js
...
const config = {
    ...
    SERVICE_NAME: process.env.SERVICE_NAME || 'Laundry Service',
...
if (missingVars.length > 0) {
    console.error(`FATAL ERROR: Missing required environment variables in laundry-service: ${missingVars.join(', ')}`);
    process.exit(1);
}
