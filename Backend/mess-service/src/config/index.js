//mess-service/src/config/index.js
...
const config = {
    ...
    SERVICE_NAME: process.env.SERVICE_NAME || 'Mess Service',
...
if (missingVars.length > 0) {
    console.error(`FATAL ERROR: Missing required environment variables in mess-service: ${missingVars.join(', ')}`);
    process.exit(1);
}
