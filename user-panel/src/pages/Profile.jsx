...
// // // FILE: src/pages/Profile.jsx (ENHANCED WITH UPGRADE BUTTON)
...
// //             setSubscriptionStatus(response.data.user.subscription || null);
...
// //     const hasActiveSubscription = subscriptionStatus && subscriptionStatus.status === 'active' && new Date(subscriptionStatus.expiresAt) > new Date();
...
// //                                             <span className={`badge ${userRole === 'admin' ? 'bg-danger' : 'bg-secondary'}`}>
...
// //                                                 <span className="badge" style={{ backgroundColor: goldColor, color: blackColor }}>
...
// //                         {!hasActiveSubscription && (
// //                             <div className="card shadow-lg border-0 mb-4" style={{ background: `linear-gradient(135deg, ${blackColor} 0%, #333 100%)` }}>
// //                                 <div className="card-body p-4 text-center text-white">
// //                                     <div className="mb-3">
// //                                         <i className="fas fa-crown fa-3x" style={{ color: goldColor }}></i>
// //                                     </div>
// //                                     <h4 className="fw-bold mb-3" style={{ color: goldColor }}>
// //                                         Upgrade to Premium
// //                                     </h4>
// //                                     <p className="mb-4 opacity-75">
// //                                         Unlock exclusive services including mess management, rental rooms, household services, and more!
// //                                     </p>
...
// //                                                 <i className="fas fa-check-circle me-2" style={{ color: goldColor }}></i>
// //                                                 <small>Mess Services</small>
// //                                             </div>
// //                                         </div>
// //                                         <div className="col-6">
// //                                             <div className="d-flex align-items-center">
// //                                                 <i className="fas fa-check-circle me-2" style={{ color: goldColor }}></i>
// //                                                 <small>Rental Rooms</small>
// //                                             </div>
// //                                         </div>
// //                                         <div className="col-6">
// //                                             <div className="d-flex align-items-center">
...
// //                                             e.target.style.color = blackColor;
// //                                         }}
// //                                         onMouseOut={(e) => {
...
// //                                         <i className="fas fa-shield-alt me-2" style={{ color: goldColor }}></i>
// //                                         <small className="opacity-75">Secure payment via Razorpay</small>
// //                                     </div>
// //                                 </div>
// //                             </div>
// //                         )}
...
// //                                         <i className="fas fa-crown me-2"></i>Premium Active
// //                                     </h5>
// //                                 </div>
// //                                 <div className="card-body p-4 text-center">
// //                                     <div className="mb-3">
// //                                         <i className="fas fa-gem fa-2x" style={{ color: goldColor }}></i>
// //                                     </div>
// //                                     <h6 className="fw-bold mb-2" style={{ color: blackColor }}>
// //                                         You're a Premium Member!
// //                                     </h6>
// //                                     <p className="text-muted mb-3">
// //                                         Enjoy unlimited access to all premium services
// //                                     </p>
...
// //                                         <span className="fw-bold" style={{ color: goldColor }}>
...
//     // ** FIX #1: Check for `endDate` instead of `expiresAt` **
...
//                                     {/* Premium Features */}
//                                     <div className="row g-2 mb-4 text-start">
//                                         <div className="col-6"><div className="d-flex align-items-center"><i className="fas fa-check-circle me-2" style={{ color: goldColor }}></i><small>Mess Services</small></div></div>
//                                         <div className="col-6"><div className="d-flex align-items-center"><i className="fas fa-check-circle me-2" style={{ color: goldColor }}></i><small>Rental Rooms</small></div></div>
//                                         <div className="col-6"><div className="d-flex align-items-center"><i className="fas fa-check-circle me-2" style={{ color: goldColor }}></i><small>Household Services</small></div></div>
//                                         <div className="col-6"><div className="d-flex align-items-center"><i className="fas fa-check-circle me-2" style={{ color: goldColor }}></i><small>Medical Services</small></div></div>
//                                         <div className="col-6"><div className="d-flex align-items-center"><i className="fas fa-check-circle me-2" style={{ color: goldColor }}></i><small>Pre-Owned Books</small></div></div>
//                                         <div className="col-6"><div className="d-flex align-items-center"><i className="fas fa-check-circle me-2" style={{ color: goldColor }}></i><small>24/7 Support</small></div></div>
//                                     </div>
                                    
//                                     <button onClick={navigateToUpgrade} className="btn w-100 py-3 fw-bold" style={{ backgroundColor: goldColor, color: blackColor, border: 'none', borderRadius: '12px', fontSize: '1.1rem', transition: 'all 0.3s ease' }} onMouseOver={(e) => { e.target.style.backgroundColor = whiteColor; e.target.style.color = blackColor; }} onMouseOut={(e) => { e.target.style.backgroundColor = goldColor; e.target.style.color = blackColor; }}>
//                                         <i className="fas fa-rocket me-2"></i>Upgrade Now
//                                     </button>
                                    
//                                     <div className="mt-3 d-flex align-items-center justify-content-center"><i className="fas fa-shield-alt me-2" style={{ color: goldColor }}></i><small className="opacity-75">Secure payment via Razorpay</small></div>
//                                 </div>
//                             </div>
//                         )}
...
//                                 </div>
//                                 <div className="card-body p-4 text-center">
//                                     <div className="mb-3"><i className="fas fa-gem fa-2x" style={{ color: goldColor }}></i></div>
...
//                                     <div className="d-flex justify-content-between align-items-center p-3 rounded" style={{ backgroundColor: '#f8f9fa' }}>
//                                         <span className="text-muted">Expires on:</span>
//                                         {/* ** FIX #2: Display `endDate` instead of `expiresAt` ** */}
