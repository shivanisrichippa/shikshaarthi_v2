      ...
      <a href="index.html" className="app-brand-link">
        <span className="app-brand-logo demo">
          <svg
            ...
            xmlnsXlink="http://www.w3.org/1999/xlink" // Note: React might prefer xmlnsXlink="http://www.w3.org/1999/xlink"
          >
            <defs>
              <path
        ...
        <span className="app-brand-text demo menu-text fw-bolder ms-2">Shikshaarthi</span>
      </a>
