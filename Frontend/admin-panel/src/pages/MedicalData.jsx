...
const MedicalData = () => {
    ...
    const renderTable = () => {
        const props = {
            serviceTypeFilter: "medical",
            showServiceFilter: false, // Always hide service filter on this page
        };

        switch (activeTab) {
            case 'pending':
                return <SubmissionTable key="pending-medical" title="Pending Medical Submissions" {...props} statusFilter="pending" showStatusFilter={false} />;
            case 'verified':
                return <SubmissionTable key="verified-medical" title="Verified Medical Submissions" {...props} statusFilter="verified" showStatusFilter={false} />;
            default:
                return <SubmissionTable key="all-medical" title="All Medical Submissions" {...props} showStatusFilter={true} />;
        }
    };
    ...
    return (
        <div className="container-xxl flex-grow-1 container-p-y">
            <h4 className="fw-bold py-3 mb-4">
                <span className="text-muted fw-light">Services Data /</span> Medical Submissions
            </h4>
