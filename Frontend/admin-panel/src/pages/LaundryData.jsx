...
const LaundryData = () => {
    ...
    const renderTable = () => {
        const props = {
            serviceTypeFilter: "laundry",
            showServiceFilter: false, // Always hide service filter on this page
        };

        switch (activeTab) {
            case 'pending':
                return <SubmissionTable key="pending-laundry" title="Pending Laundry Submissions" {...props} statusFilter="pending" showStatusFilter={false} />;
            case 'verified':
                return <SubmissionTable key="verified-laundry" title="Verified Laundry Submissions" {...props} statusFilter="verified" showStatusFilter={false} />;
            default:
                return <SubmissionTable key="all-laundry" title="All Laundry Submissions" {...props} showStatusFilter={true} />;
        }
    };
    ...
    return (
        <div className="container-xxl flex-grow-1 container-p-y">
            <h4 className="fw-bold py-3 mb-4">
                <span className="text-muted fw-light">Services Data /</span> Laundry Submissions
            </h4>
