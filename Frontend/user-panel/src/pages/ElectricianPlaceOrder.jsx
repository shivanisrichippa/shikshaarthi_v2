...
import electricianData from "../data/electricianData";

const ElectricianPlaceOrder = () => {
  const { id } = useParams();
  ...
  const serviceCharge = 200; // Base service charge
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Navigate to the /electrician/orders page after form submission
    navigate("/electrician/orders");
  };

  return (
    <div className="container mt-5 py-5">
      <h2 className="fw-bold text-center">Book an Electrician</h2>
...
export default ElectricianPlaceOrder;
